// Redistricting_StaticCompetitionMeasures.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
// Comment out by AB 3.30, Not needed for Static Measures
...
// Comment out by AB on 3.30, not currently being calculated as static measure
...
// Comment out by AB on 3.30, not currently calculating these metrics for output.
//struct outputbag {
//	bool doVariance;
//	bool doMedianMean;
...
// Comment out by AB 3.30, currently working on static measures, not stepping to other maps.
...
// Comment out by AB 3.30, not currently changing maps.
...
// Comment out by AB 3.30, breaking from current loop process.
...
int main(int argc, char* argv[])
{
	...
	// Comment out by AB 3.30, not currently outputting tests
...
// Comment out by AB 3.30, breaking rom main loop
//	//MAIN LOOP
//	//  double p=((double) firstD.edgeset.count)/g_MAXEDGES;
//	if (StatTest == rootep) {
//		int t = 0;
