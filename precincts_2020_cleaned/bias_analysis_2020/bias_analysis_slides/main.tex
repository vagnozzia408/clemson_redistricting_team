...
\textbf{Median-Mean}    & $-0.0238$                                                               & \cellcolor[HTML]{FFCCC9}$-0.0336$                                      \\ \hline
\textbf{Geometric Bias} & $0.0231$                                                                & \cellcolor[HTML]{FFCCC9}$0.0352$                                       \\ \hline
\textbf{Efficiency Gap} & 0.2624                                                                & \cellcolor[HTML]{C6ECC6}0.1117                                       \\ \hline
\end{tabular}
\end{table}
\end{center}
...
\hline
\textbf{}               & \textbf{\begin{tabular}[c]{@{}c@{}}Original 2011 Map\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Proposed 2021 Map\end{tabular}} \\ \hline
\textbf{Median-Mean}    & $-0.0328$                                                               & \cellcolor[HTML]{FFCCC9}$-0.0348$                                      \\ \hline
\textbf{Geometric Bias} & $0.0301$                                                                & \cellcolor[HTML]{C6ECC6}$0.0260$                                       \\ \hline
\textbf{Efficiency Gap} & $0.0685$                                                                & \cellcolor[HTML]{FFCCC9}$0.0800$                                       \\ \hline
\end{tabular}
\end{table}
\end{center}
...
\hline
\textbf{}               & \textbf{\begin{tabular}[c]{@{}c@{}}Original 2011 Map\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Proposed 2021 Map\end{tabular}} \\ \hline
\textbf{Median-Mean}    & $-0.0445$                                                               & \cellcolor[HTML]{C6ECC6}$-0.0273$                                      \\ \hline
\textbf{Geometric Bias} & $0.0408$                                                                & \cellcolor[HTML]{C6ECC6}$0.0341$                                       \\ \hline
\textbf{Efficiency Gap} & $0.0976$                                                                & \cellcolor[HTML]{C6ECC6}$0.0903$                                       \\ \hline
\end{tabular}
\end{table}
\end{center}
