...
# This is created in ArcMap by Tabulating the Intersection of precinct lines and point features.
...
print
for i in range(5):
    print str(clockwise_dict.items()[i][0]) + ": " + str(clockwise_dict.items()[i][1])
    print
...
print
for i in range(5):
    print str(endpoint_dict.items()[i][0]) + ": " + str(endpoint_dict.items()[i][1])
    print
...
print("Success! Your neighbor list has been calculated.")